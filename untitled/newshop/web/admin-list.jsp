                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                              ...
                              <c:forEach items="${list}" var="admin" varStatus="status">
                                <tr>
                                  <td>
                                    <input type="checkbox"  name="aid" value="${admin.aId}" lay-skin="primary">
                                  </td>
                                  <td>${status.count}</td>
                                   <td>${admin.account}</td>
                                  ...
                                  <td class="td-manage">
                                    ...
                                    <a title="编辑"  onclick="xadmin.open('编辑','admin-p-update?id=${admin.aId}')" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除"  href="javascript: deleteAdmin(${admin.aId});">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
